...
const projects = [
  {
    id: 1,
    title: "AI-powered image generation web app",
    company: "UB",
    ...
    description: [
      "Built a MERN Stack AI Image generation app integrated with OpenAI’s DALL-E API to produce 500+ output images from text prompts, achieving 1.2s average generation time through Node.js microservices and Redis caching.",
      "Implemented Cloudinary CDN for storing 1K+ high-res images, coupled with MongoDB Atlas vector search that lessened image retrieval latency by 40% through optimized indexing strategies."
    ],
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: "Amazon Book Recommendation System",
    company: "UB",
    ...
    description: [
      "Developed a data processing pipeline and web application to manage and query over 100,000 Amazon book reviews, achieving BCNF compliance through effective database normalization and optimizing query performance with indexing."
    ],
  },
  {
    id: 4,
    title: "Credit Card Fraud Detecion",
    company: "UB",
    duration: "Aug 2024 - Oct 2024",
    techStack: [
      "Python",
    ...
    description: [
      " A machine learning-based model that detects fraudulent transactions using anomaly detection, behavioral analytics, and risk scoring. Built with Python, Pandas, Scikit-learn, and real-world datasets."
    ],
  },
  {
    id: 5,
    title: "Predictive Ad Targeting Optimization Model Development",
    ...
    description: [
      "Developed predictive analytics pipeline using XGBoost and feature engineering to optimize digital ad targeting, analyzing 1M+ user interactions in Python (Pandas/Scikit-learn) to reduce wasted ad spend by 22% while maintaining 93% prediction accuracy"
    ],
  },
];
